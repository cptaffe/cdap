 ...
 * Use {@link ConfiguratorFactory} with isRemote set to true if worker pool is enabled.
 * Use {@link ConfiguratorFactory} with isRemote set to false if worker pool is disabled.
 */
