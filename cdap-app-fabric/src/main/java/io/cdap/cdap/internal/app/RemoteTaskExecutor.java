...
public class RemoteTaskExecutor {
  ...
  public byte[] runTask(RunnableTaskRequest runnableTaskRequest) throws Exception {
    ...
    return Retries.callWithRetries(() -> {
      ...
      } catch (NoRouteToHostException | ServiceUnavailableException e) {
        throw new RetryableException(
  ...
  private Exception createExceptionObject(@Nullable BasicThrowable basicThrowable) {
    ...
    RemoteTaskException remoteTaskException = new RemoteTaskException(exceptionMessage,
                                                                      createExceptionObject(basicThrowable.getCause()));
